#!/usr/bin/env node
/**
 * Download SGLG 2024 Safety, Peace and Order indicators and build JSON for the app.
 * Source sheet: 1_B3lXRHFADapgp3he7w_2IxQuYqk_GdWoeC1WR5j09g (gid 0)
 * Output: public/sglg_safety_peace_2024.json
 */
const https = require('https')
const fs = require('node:fs')
const path = require('node:path')

const SHEET_ID = '1_B3lXRHFADapgp3he7w_2IxQuYqk_GdWoeC1WR5j09g'
const GID = '0'
const YEAR = 2024
const CSV_PATH = path.join('datasets', 'sglg_safety_peace_2024.csv')
const OUTPUT_PATH = path.join('public', 'sglg_safety_peace_2024.json')

const COLUMNS = [
  ['POC Process', 'poc_process', 'POC Process'],
  ['ADAC Process', 'adac_process', 'ADAC Process'],
  ['Support to PNP', 'support_to_pnp', 'Support to PNP'],
  ['BPATS Process', 'bpats_process', 'BPATS Process'],
  ['Firecracker and other pyrotechnic devices regulation process', 'firecracker_regulation_process', 'Firecracker and pyrotechnics regulation process'],
